...
namespace by.Reba.DataBase.Migrations
{
    ...
    [Migration("20221205102330_add_refresh_token")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_History", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_Preference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("MinPositivityId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("T_CategoryT_Preference", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "PreferencesId");

                    b.HasIndex("PreferencesId");

                    b.ToTable("PreferencesCategories", (string)null);
                });
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_Article", b =>
                {
                    ...
                    b.HasOne("by.Reba.DataBase.Entities.T_Positivity", "Positivity")
                        .WithMany("Articles")
                        .HasForeignKey("PositivityId");
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_Preference", b =>
                {
                    b.HasOne("by.Reba.DataBase.Entities.T_Positivity", "MinPositivity")
                        .WithOne("Preference")
                        .HasForeignKey("by.Reba.DataBase.Entities.T_Preference", "MinPositivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("by.Reba.DataBase.Entities.T_User", "User")
                        .WithOne("Preference")
                        .HasForeignKey("by.Reba.DataBase.Entities.T_Preference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MinPositivity");
            ...
            modelBuilder.Entity("T_CategoryT_Preference", b =>
                {
                    ...
                    b.HasOne("by.Reba.DataBase.Entities.T_Preference", null)
                        .WithMany()
