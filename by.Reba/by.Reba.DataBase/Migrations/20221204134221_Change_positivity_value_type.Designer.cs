...
namespace by.Reba.DataBase.Migrations
{
    ...
    [Migration("20221204134221_Change_positivity_value_type")]
    partial class Change_positivity_value_type
    {
            ...
            modelBuilder.Entity("by.Reba.DataBase.Entities.T_Preference", b =>
                {
                    b.HasOne("by.Reba.DataBase.Entities.T_Positivity", "MinPositivityRating")
                        ...
                        .HasForeignKey("by.Reba.DataBase.Entities.T_Preference", "PositivityRatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
